...
function Wt() {
  ...
  var oe = Array.isArray, M = Object.prototype.hasOwnProperty, z = { current: null }, ce = { key: !0, ref: !0, __self: !0, __source: !0 };
  function pe(n, s, h) {
...
function Yt() {
  return dt || (dt = 1, process.env.NODE_ENV !== "production" && function() {
    ...
    var oe = !1, M = !1, z = !1, ce = !1, pe = !1, Re;
    Re = Symbol.for("react.module.reference");
    function Ce(t) {
      return !!(typeof t == "string" || typeof t == "function" || t === X || t === re || pe || t === de || t === Z || t === L || ce || t === H || oe || M || z || typeof t == "object" && t !== null && (t.$$typeof === ee || t.$$typeof === V || t.$$typeof === te || t.$$typeof === Q || t.$$typeof === $ || // This needs to include all possible module reference object
      // types supported by any Flight configuration anywhere since
      // we don't know which Flight build this will end up being used
      // with.
    ...
    function or(t, u) {
      {
        ...
        ar[c] = !0;
        var f = "";
        t && t._owner && t._owner !== Ne.current && (f = " It was passed a child from " + q(t._owner.type) + "."), ve(t), I('Each child in a list should have a unique "key" prop.%s%s See https://reactjs.org/link/warning-keys for more information.', c, f), ve(null);
      }
    }
    function ur(t, u) {
      {
...
var Bt = Mr.exports;
const zt = () => /* @__PURE__ */ Bt.jsx("div", { children: "Hello from MyComponent!" }), qt = { MyComponent: zt };
export {
  zt as MyComponent,
  qt as default
};
